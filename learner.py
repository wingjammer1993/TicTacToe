...
# def give_rep_from_state(self):
#     ternary_state = numpy.ndarray.flatten(self.board)
#     int_ternary = [int(x) for x in ternary_state]
#     str1 = ''.join(map(str, int_ternary))
#     return str1
#
# # returns the state representation of the board state
# def give_state_from_rep(self, state_str):
